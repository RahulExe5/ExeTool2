  ...
  return (
    ...
    >
      <div className="glass-morphism rounded-2xl p-8 shadow-xl">
        ...
        <p className="text-xl text-desc mb-8 leading-relaxed">
          Your one-stop dashboard for powerful tools. Click the menu icon to explore our collection of utilities designed to make your work easier and more efficient.
        </p>
